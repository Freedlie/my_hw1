...
// let paragraphs = [];
//
// function foo(childrenOfBody) {
//
//     if(childrenOfBody.tagName === 'P'){
//         paragraphs.push(childrenOfBody.innerText);
//     }
//     else if(childrenOfBody.tagName === 'H2'){
//         headings.push(childrenOfBody.innerText);
//     }
//     else if (childrenOfBody.children) {
//         for (const children of childrenOfBody.children) {
//             foo(children);
//         }
//     }
// }
